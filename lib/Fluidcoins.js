...
class FluidCoins {
   ...
   * @param {Object} data The name of the customer
   ...
   * @param {string} data.phone.phone The phone number of the customer
   * @returns {Promise<any | undefined>} The response
   */
   ...
   * @param {'NGN'} data.currency='NGN' - The currency type only 'NGN' is supported
   * @returns {Promise<any | undefined>} The response
   */
