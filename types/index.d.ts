...
declare class  FluidCoins {
   ...
   */
  getAddresses(coin_id?: string, page?: number,per_page?: number ): Promise<any | undefined>
   ...
   * @param per_page Number to items to return. Defaults to 20 items
   */
  getAddressTransactions(reference: string, page? : number, per_page?: number): Promise<any | undefined>
    ...
    */
   getCustomers(blacklist?: boolean, page?: number, per_page?: number): Promise<any | undefined>
    ...
    */
   getPaymentLinks(status?: 'disabled' | 'enabled', page?: number, per_page?: number): Promise<any | undefined>
    ...
    */
   editPaymentLink(reference: string, data: PaymentData): Promise<any | undefined>
  ...
  //  swapCurrencies(amount:number, from: string, to: string): Promise<any | undefined>
    ...
    */
   getAllTransactions(status?: Status, page?: number, per_page?: number): Promise<any | undefined>
